...
generated by each signer are from distinct subset of possible values. On Knot, this
can be achieved with :ref:`policy_keytag-modulo` option (e.g. for three signers, setting
"0/3" on first one, "1/3" on second and "2/3" on third of them).
