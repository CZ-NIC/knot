...
**zone-backup** [*zone*...] **+backupdir** *directory* [*filter*...]
  ...
  **+kaspdb**, **+catalog**, **+quic**, and **+nojournal** are set. Setting
  a filter for an item doesn't change default settings for other items.
  If zone flushing is disabled, original zone file is backed up instead of
...
**zone-restore** [*zone*...] **+backupdir** *directory* [*filter*...]
  ...
  In contrast with **zone-backup**, **+noquic** is the default for restore.
