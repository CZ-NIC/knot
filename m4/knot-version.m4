...
#
# To force short version format set env variable KNOT_VERSION_FORMAT=short
#
...
m4_define([knot_GIT_OK],    m4_case(m4_esyscmd_s(echo $KNOT_VERSION_FORMAT 2>/dev/null), short, [], knot_GIT_HASH))dnl
