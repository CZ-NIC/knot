...
resp = slave.dig("catalog1.", "SOA", protocol=Protocol.TCP, tsig=True)
resp.check(rcode="NOERROR")
resp = slave.dig("cataloged1.", "SOA", protocol=Protocol.TCP, tsig=True)
resp.check(rcode="NOERROR")
...
resp = master.dig("catalog1.", "SOA", protocol=Protocol.TCP, tsig=True)
resp.check(rcode="SERVFAIL")
resp = slave.dig("catalog1.", "SOA", protocol=Protocol.TCP, tsig=True)
resp.check(rcode="SERVFAIL")
