...
beside_cname.add(cn, 3600, "CNAME", "example.com.")
...
cname_beside.add(cn, 3600, "CNAME", "example.com.")
...
dn = rnd_label()
subdn = rnd_label()
below_dname.add(dn, 3600, "DNAME", "example.com.")
below_dname.add(subdn + "." + dn, 3600, "A", "1.2.3.8")
check_faulty_update(below_dname, master, zone, True, True)
