...
masterA = t.server("knot", address="127.0.0.2")
masterB = t.server("knot", address="127.0.0.3")
slave = t.server("knot", address="127.0.0.4")
zones = t.zone("example.", storage=("." if DISABLE_NOTIFY else None))
zone = zones[0]
