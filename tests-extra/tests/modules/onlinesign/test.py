...
knot.zones[zones[0].name].zfile.append_rndTXT("tc", rdata=None, rdlen=255)
knot.zones[zones[0].name].zfile.append_rndTXT("tc", rdata=None, rdlen=255)
knot.zones[zones[0].name].zfile.append_rndTXT("tc", rdata=None, rdlen=255)
knot.zones[zones[0].name].zfile.append_rndTXT("tc", rdata=None, rdlen=255)
knot.zones[zones[0].name].zfile.append_rndTXT("tc", rdata=None, rdlen=80)
...
# Check only TC when adding an RRSIG; other cases are difficult to trigger with a minimum packet size of 512 bytes.
