...
key_ksk1 = knot.key_gen(ZONE, ksk="true", created="+0", publish="+0", ready="+0", active="+0", retire="+40", remove="+50")
key_ksk2 = knot.key_gen(ZONE, ksk="true", created="+0", publish="+20", ready="+30", active="+40", retire="+2h", remove="+3h")
