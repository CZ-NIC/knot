...
static knot_rrtype_descriptor_t
       knot_rrtype_descriptors[DNSLIB_RRTYPE_DESCRIPTORS_LENGTH] = {
        /* 0 */
  ...
  { DNSLIB_RDATA_ZF_SHORT, DNSLIB_RDATA_ZF_ALGORITHM, DNSLIB_RDATA_ZF_BYTE, DNSLIB_RDATA_ZF_HEX }, true },
  	...
  	{ DNSLIB_RRTYPE_RRSIG, "RRSIG", 9,
	    ...
	    DNSLIB_RDATA_WF_BINARY },
	    { DNSLIB_RDATA_ZF_RRTYPE, DNSLIB_RDATA_ZF_ALGORITHM,
              DNSLIB_RDATA_ZF_BYTE, DNSLIB_RDATA_ZF_PERIOD,
              DNSLIB_RDATA_ZF_TIME, DNSLIB_RDATA_ZF_TIME,
              DNSLIB_RDATA_ZF_SHORT, DNSLIB_RDATA_ZF_LITERAL_DNAME,
              DNSLIB_RDATA_ZF_BASE64 }, true },
  	/* 47 */
  	...
  	{ DNSLIB_RRTYPE_DNSKEY, "DNSKEY", 4,
  	  { DNSLIB_RDATA_WF_SHORT, DNSLIB_RDATA_WF_BYTE,
	    DNSLIB_RDATA_WF_BYTE, DNSLIB_RDATA_WF_BINARY },
	  { DNSLIB_RDATA_ZF_SHORT, DNSLIB_RDATA_ZF_BYTE,
            DNSLIB_RDATA_ZF_ALGORITHM, DNSLIB_RDATA_ZF_BASE64 }, true },
  	/* 49 */
...
knot_rrtype_descriptor_t *knot_rrtype_descriptor_by_type(uint16_t type)
{
	if (type < DNSLIB_RRTYPE_LAST + 1) {
		...
		return &knot_rrtype_descriptors[DNSLIB_RRTYPE_DLV];
	}
...
knot_rrtype_descriptor_t *knot_rrtype_descriptor_by_name(const char *name)
{
	...
	if (knot_rrtype_descriptors[DNSLIB_RRTYPE_DLV].name &&
	    strcasecmp(knot_rrtype_descriptors[DNSLIB_RRTYPE_DLV].name,
	                              name) == 0) {
		return &knot_rrtype_descriptors[DNSLIB_RRTYPE_DLV];
	}
