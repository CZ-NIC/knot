 ...
 * \return Error code, KNOT_EOK if successful.
 */
int knot_edns_zoneversion_write(uint8_t *option, uint16_t option_len,
 ...
 * \return Error code, KNOT_EOK if successful.
 */
int knot_edns_zoneversion_parse(knot_dname_storage_t zone, uint8_t *type, uint32_t *version,
                                const uint8_t *option, uint16_t option_len,
