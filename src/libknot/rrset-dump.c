...
static void wire_generic_paramkey_to_str(rrset_dump_params_t *p, const knot_lookup_t *paramkey_names)
{
	uint16_t param_key = knot_wire_read_u16(p->in);
	const knot_lookup_t *type = knot_lookup_by_id(paramkey_names, param_key);
