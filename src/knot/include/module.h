...
typedef enum {
	...
	KNOTD_STAGE_PROTO_END,        /*!< End of transport processing. */
} knotd_stage_t;

/*!
 * Protocol processing hook.
 *
...
/*!
 * Registers protocol processing module hook.
 *
 * \param[in] mod    Module context.
 * \param[in] stage  Processing stage (KNOTD_STAGE_PROTO).
