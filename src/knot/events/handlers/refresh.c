...
static bool ixfr_error_failover(int ret)
{
	...
	case KNOT_ETIMEOUT:
		return false;
	default: // probably: ENOMEM, EINVAL, ENOTSUP, EBUSY, EAGAIN, EACCESS, ENOENT, ERANGE, ERROR, ESEMCHECK, ESPACE, EMALF, EOUTOFZONE, ENONODE, ENORECORD, ETTL, EDENIED, EZONESIZE, ESOAINVAL, EISRECORD
		return true;
	}
}
