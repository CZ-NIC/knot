...
load_end:
	...
	if (!zone_journal_same_serial(up.zone, new_serial)) { // heursitsics: this catches most of the cases when the zone load doesn'T introduce any change to zone contents and external validation is useless
