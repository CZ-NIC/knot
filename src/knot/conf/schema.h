...
#define C_QUIC_WORKERS		"\x0C""quic-workers"
#define C_QUIC_PORT		"\x09""quic-port"
#define C_QUIC_CERT_FILE		"\x09""quic-cert"
#define C_QUIC_KEY_FILE		"\x08""quic-key"
#define C_QUIC_SECRET		"\x0B""quic-secret"
...
#define C_TLS_IDLE_TIMEOUT	"\x10""tls-idle-timeout"
#define C_TLS_IO_TIMEOUT	"\x0E""tls-io-timeout"
#define C_TLS_MAX_CLIENTS	"\x0F""tls-max-clients"
...
#define C_TLS_TRUST_FILE	"\x0E""tls-trust-file"
#define C_TLS_CERT_FILE		"\x0D""tls-cert-file"
#define C_TLS_KEY_FILE		"\x0C""tls-key-file"
