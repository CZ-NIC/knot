...
#define C_DNSSEC_JITTER		"\x0D""dnssec-jitter"
...
#define C_REFRESH_JITTER	"\x0E""refresh-jitter"
...
#define C_TRASH_DELAY		"\x0B""trash-delay"
...
#define C_ZERO_COPY		"\x09""zero-copy"
...
#define CONF_NSEC3_MAX_ITERS	256

enum {
	KEYSTORE_BACKEND_PEM    = 1,
	KEYSTORE_BACKEND_PKCS11 = 2,
	KEYSTORE_BACKEND_ZONEDB = 3,
};
