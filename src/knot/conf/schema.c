...
static const yp_item_t desc_server[] = {
	...
	{ C_TLS_WORKERS,          YP_TINT,  YP_VINT = { 0, 255, YP_NIL } },
	{ C_QUIC_WORKERS,         YP_TINT,  YP_VINT = { 0, CONF_MAX_UDP_WORKERS, YP_NIL } },
	{ C_QUIC_PORT,            YP_TINT,  YP_VINT = { 0, 65535, 784 } },
	...
	{ C_QUIC_CERT_FILE,       YP_TSTR,  YP_VNONE },
	{ C_QUIC_KEY_FILE,        YP_TSTR,  YP_VNONE },
	{ C_QUIC_SECRET,          YP_TSTR,  YP_VNONE },
	{ C_SOCKET_AFFINITY,      YP_TBOOL, YP_VNONE },
	{ C_TLS_IDLE_TIMEOUT,     YP_TINT,  YP_VINT = { 1, INT32_MAX, 10, YP_STIME } },
	{ C_TLS_IO_TIMEOUT,       YP_TINT,  YP_VINT = { 0, INT32_MAX, 200 } },
	{ C_TLS_MAX_CLIENTS,      YP_TINT,  YP_VINT = { 0, INT32_MAX, YP_NIL } },
	{ C_TLS_PORT,             YP_TINT,  YP_VINT = { 1, UINT16_MAX, 853 } },
	{ C_TLS_TRUST_FILE,       YP_TSTR,  YP_VNONE },
	{ C_TLS_CERT_FILE,        YP_TSTR,  YP_VNONE },
	{ C_TLS_KEY_FILE,         YP_TSTR,  YP_VNONE },
