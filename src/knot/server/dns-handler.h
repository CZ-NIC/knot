...
/*!
 * \brief Initialize dns request basic parameters.
 *
 * \param dns_handler DNS handler.
 * \param dns_req DNS request to be initialized.
 * \param sock Network socket.
 * \param proto Transport protocol.
 */
void initialize_dns_request(dns_request_handler_context_t *dns_handler, dns_handler_request_t *dns_req, int sock,
