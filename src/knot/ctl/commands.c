 ...
 * \param[in/out] filters     Bit-mapped filter set to be updated.
 * \param[in]     param       A backup component to be set.
 * \param[in]     dflt        Default filter value.
 * \param[in]     filter      Ctl name of the filter.
 * \param[in]     neg_filter  Ctl name of the negative filter.
 *
