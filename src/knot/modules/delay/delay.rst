...
The value indicates if all module call needs to be delayed or final response
alone needs to be delayed. If all module calls are delayed, then total time
the query is delayed will be number of module hooks available * delay time.
