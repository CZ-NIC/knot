...
#define MOD_SERVER_SECRET   "\x0D""server-secret"
...
int cookies_load(knotd_mod_t *mod)
{
	...
	conf = knotd_conf_mod(mod, MOD_SERVER_SECRET);
	if (conf.count == 1) {
