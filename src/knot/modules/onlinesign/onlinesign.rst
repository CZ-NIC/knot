...
A list of Resource Record types always included in an NSEC bitmap generated by the module. 
This option may be useful for caching resolvers when using other modules which may synthetise responses of types
not present in the zone, such as the :ref:`synthrecord<mod-synthrecord>` and :ref:`GeoIP<mod-geoip>` modules. By default
this option is set to comply with :ref:`synthrecord<mod-synthrecord>` and thus include the A and AAAA records in the NSEC bitmap.
