...
#define parse_report_query test_parse_report_query
...
static void _test_parse_report_query(const char *dname_txt, int expected)
{
	...
	int ret = parse_report_query(&parsed, dname);
...
int main(int argc, char *argv[])
{
	...
	test_fail_parse_report_query(".");
	test_fail_parse_report_query("a");
	test_fail_parse_report_query("a._er");
	test_fail_parse_report_query("_er");
	test_fail_parse_report_query("1.a.1._er");
	test_fail_parse_report_query("a.1.a.1._er");
	test_fail_parse_report_query("a._er.1.a.1._er");
