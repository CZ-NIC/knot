...
install -d -m 0775 -D %{buildroot}%{_sharedstatedir}/knot
install -d -m 0770 -D %{buildroot}%{_sharedstatedir}/knot/catalog
install -d -m 0770 -D %{buildroot}%{_sharedstatedir}/knot/journal
install -d -m 0770 -D %{buildroot}%{_sharedstatedir}/knot/keys
install -d -m 0770 -D %{buildroot}%{_sharedstatedir}/knot/timers
...
%{_mandir}/man8/knotc.*
%{_mandir}/man8/knotd.*
%ghost %attr(755,root,knot) %dir %{_rundir}/knot
